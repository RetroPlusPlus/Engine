...
public:
    ...
    // is a free function over an AudioSystem (Game Boy presets in gbcpp/gb_audio.h, the way the Game Boy
    // RNG presets in gbcpp/gb_routines.h sit over the generic Vm). A SNES / Genesis audio system brings
