...
# A bare Windows box ships execution policy = Restricted, which refuses to run this script at all. Invoke
# it with the bypass flag (process scope — always effective, no persistent change, no admin needed):
