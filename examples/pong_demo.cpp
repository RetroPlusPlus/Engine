...
#include "retropp/tween.h"          // Tween<T> / TweenPlayer<T> / Easing — ENG-2.J value animation
...
int main() {
    ...
    loop.setRender([&](float alpha) {
        ...
        // Float game-state is quantized to integer screen pixels HERE, at the write into Sprite::x/y.
