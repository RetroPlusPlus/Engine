; ball_lost — the ball fell past the paddle. A low, longer "buzz" on pulse CH1, 25% duty (~250 Hz), a
; slow envelope so it sinks rather than snaps — the only down-beat cue. Self-contained; CH1 sweep off.
ld a, $80
