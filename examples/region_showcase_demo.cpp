...
int main() {
    ...
    const AtlasId opaque = renderer.uploadAtlas(atlasPx.data(), 24, 8).atlasId;
    const AtlasId holed  = renderer.uploadAtlas(atlasPx.data(), 24, 8, TransparentIndices::of({0})).atlasId;
