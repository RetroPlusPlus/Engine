...
int main() {
    ...
    const AtlasId atlas     = renderer.uploadAtlas(atlasPx.data(), kColours * 8, 8).atlasId;
    const AtlasId holeAtlas = renderer.uploadAtlas(atlasPx.data(), kColours * 8, 8, TransparentIndices::of({0})).atlasId;
