...
| Built-in effect library (`RowDisplacement` wave, `Ripple` droplet, `ColorFill` solid colour fill / drawn line — name the kind, the engine owns the shader) | available | draw-state.md |
