...
| Region-confined screen-space effects (confine any effect to a polygon, a curve, or an SDF shape) | available | draw-state.md |
| Region cutout / stencil (erase a layer inside or outside a shape, feathered — reveal the layers below or the backdrop) | available | draw-state.md |
